...
abstract class AbstractSinhalaDetectionAccuracyReport(
    implementationToUse: LanguageDetectorImplementation
) : AbstractLanguageDetectionAccuracyReport(Language.SINHALA, implementationToUse) {

    @ParameterizedTest
    @CsvFileSource(
        resources = ["/language-testdata/single-words/sin.txt"],
    ...
    @ParameterizedTest
    @CsvFileSource(
        resources = ["/language-testdata/word-pairs/sin.txt"],
        delimiter = CSV_FILE_DELIMITER,
        encoding = CSV_FILE_ENCODING
    )
    ...
    @ParameterizedTest
    @CsvFileSource(
        resources = ["/language-testdata/sentences/sin.txt"],
        delimiter = CSV_FILE_DELIMITER,
        encoding = CSV_FILE_ENCODING
    )
