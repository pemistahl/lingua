...
abstract class AbstractYorubaDetectionAccuracyReport(
    implementationToUse: LanguageDetectorImplementation
) : AbstractLanguageDetectionAccuracyReport(Language.YORUBA, implementationToUse) {

    @ParameterizedTest
    @CsvFileSource(
        resources = ["/language-testdata/single-words/yor.txt"],
    ...
    @ParameterizedTest
    @CsvFileSource(
        resources = ["/language-testdata/word-pairs/yor.txt"],
        delimiter = CSV_FILE_DELIMITER,
        encoding = CSV_FILE_ENCODING
    )
    ...
    @ParameterizedTest
    @CsvFileSource(
        resources = ["/language-testdata/sentences/yor.txt"],
        delimiter = CSV_FILE_DELIMITER,
        encoding = CSV_FILE_ENCODING
    )
