...
abstract class AbstractZuluDetectionAccuracyReport(
    implementationToUse: LanguageDetectorImplementation
) : AbstractLanguageDetectionAccuracyReport(Language.ZULU, implementationToUse) {

    @ParameterizedTest
    @CsvFileSource(
        resources = ["/language-testdata/single-words/zul.txt"],
    ...
    @ParameterizedTest
    @CsvFileSource(
        resources = ["/language-testdata/word-pairs/zul.txt"],
        delimiter = CSV_FILE_DELIMITER,
        encoding = CSV_FILE_ENCODING
    )
    ...
    @ParameterizedTest
    @CsvFileSource(
        resources = ["/language-testdata/sentences/zul.txt"],
        delimiter = CSV_FILE_DELIMITER,
        encoding = CSV_FILE_ENCODING
    )
