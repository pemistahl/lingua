...
class LanguageDetectorTest {
    ...
    private val unigramLanguageModelForEnglish =
        Object2FloatOpenHashMap<String>().apply {
            putAll(
                mapOf(
                    "a" to 0.01F,
                    "l" to 0.02F,
    ...
    private val bigramLanguageModelForEnglish =
        Object2FloatOpenHashMap<String>().apply {
            putAll(
                mapOf(
                    "al" to 0.11F,
    ...
    private val trigramLanguageModelForEnglish =
        Object2FloatOpenHashMap<String>().apply {
            putAll(
                mapOf(
                    "alt" to 0.19F,
    ...
    private val quadrigramLanguageModelForEnglish =
        Object2FloatOpenHashMap<String>().apply {
            putAll(
                mapOf(
                    "alte" to 0.25F,
    ...
    private val fivegramLanguageModelForEnglish =
        Object2FloatOpenHashMap<String>().apply {
            putAll(
                mapOf(
                    "alter" to 0.29F,
    ...
    private val unigramLanguageModelForGerman =
        Object2FloatOpenHashMap<String>().apply {
            putAll(
                mapOf(
                    "a" to 0.06F,
    ...
    private val bigramLanguageModelForGerman =
        Object2FloatOpenHashMap<String>().apply {
            putAll(
                mapOf(
                    "al" to 0.15F,
    ...
    private val trigramLanguageModelForGerman =
        Object2FloatOpenHashMap<String>().apply {
            putAll(
                mapOf(
                    "alt" to 0.22F,
    ...
    private val quadrigramLanguageModelForGerman =
        Object2FloatOpenHashMap<String>().apply {
            putAll(
                mapOf(
                    "alte" to 0.27F,
    ...
    private val fivegramLanguageModelForGerman =
        Object2FloatOpenHashMap<String>().apply {
    ...
    private var detectorForEnglishAndGerman =
        LanguageDetector(
    ...
    private val detectorForAllLanguages =
        LanguageDetector(
    ...
    private fun ngramProbabilityProvider() =
        listOf(
    ...
    private fun ngramProbabilitySumProvider() =
        listOf(
            arguments(
    ...
    private fun languageProbabilitiesProvider() =
        listOf(
            arguments(
