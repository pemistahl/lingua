...
abstract class AbstractVietnameseDetectionAccuracyReport(
    ...
    @ParameterizedTest
    @CsvFileSource(resources = ["/language-testdata/single-words/vi.txt"], delimiter = CSV_FILE_DELIMITER, encoding = CSV_FILE_ENCODING)
    ...
    @ParameterizedTest
    @CsvFileSource(resources = ["/language-testdata/word-pairs/vi.txt"], delimiter = CSV_FILE_DELIMITER, encoding = CSV_FILE_ENCODING)
    ...
    @ParameterizedTest
    @CsvFileSource(resources = ["/language-testdata/sentences/vi.txt"], delimiter = CSV_FILE_DELIMITER, encoding = CSV_FILE_ENCODING)
