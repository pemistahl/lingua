...
abstract class AbstractKlingonDetectionAccuracyReport(
    implementationToUse: LanguageDetectorImplementation
) : AbstractLanguageDetectionAccuracyReport(Language.KLINGON, implementationToUse) {

    @ParameterizedTest
    @CsvFileSource(
        resources = ["/language-testdata/single-words/tlh.txt"],
    ...
    @ParameterizedTest
    @CsvFileSource(
        resources = ["/language-testdata/word-pairs/tlh.txt"],
        delimiter = CSV_FILE_DELIMITER,
        encoding = CSV_FILE_ENCODING
    )
    ...
    @ParameterizedTest
    @CsvFileSource(
        resources = ["/language-testdata/sentences/tlh.txt"],
        delimiter = CSV_FILE_DELIMITER,
        encoding = CSV_FILE_ENCODING
    )
