...
abstract class AbstractGujaratiDetectionAccuracyReport(
    ...
    @ParameterizedTest
    @CsvFileSource(resources = ["/language-testdata/single-words/gu.txt"], delimiter = CSV_FILE_DELIMITER, encoding = CSV_FILE_ENCODING)
    ...
    @ParameterizedTest
    @CsvFileSource(resources = ["/language-testdata/word-pairs/gu.txt"], delimiter = CSV_FILE_DELIMITER, encoding = CSV_FILE_ENCODING)
    ...
    @ParameterizedTest
    @CsvFileSource(resources = ["/language-testdata/sentences/gu.txt"], delimiter = CSV_FILE_DELIMITER, encoding = CSV_FILE_ENCODING)
