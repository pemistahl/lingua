...
class TrainingDataLanguageModelTest {
    ...
    private val expectedUnigramAbsoluteFrequencies =
        mapOf(
    ...
    private val expectedUnigramRelativeFrequencies =
        mapOf(
    ...
    private val expectedUnigramJsonRelativeFrequencies =
        expectedUnigramRelativeFrequencies.mapValues {
            it.value.toFloat()
        }

    private val expectedBigramAbsoluteFrequencies =
        mapOf(
    ...
    private val expectedBigramRelativeFrequencies =
        mapOf(
    ...
    private val expectedTrigramAbsoluteFrequencies =
        mapOf(
    ...
    private val expectedTrigramRelativeFrequencies =
        mapOf(
    ...
    private val expectedQuadrigramAbsoluteFrequencies =
        mapOf(
    ...
    private val expectedQuadrigramRelativeFrequencies =
        mapOf(
    ...
    private val expectedFivegramAbsoluteFrequencies =
        mapOf(
    ...
    private val expectedFivegramRelativeFrequencies =
        mapOf(
